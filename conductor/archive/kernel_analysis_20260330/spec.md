...
## Overview
Enhance the Conductor workflow by adding an automatic analysis step at the end of each phase/track. This step will identify newly created componentry that could be added to the `design-os-kernel` to maintain a high-quality, reusable Golden Source of components.
...
4. **Workflow Integration:** Officially document this step in `conductor/workflow.md`.
...
## Acceptance Criteria
- `conductor/workflow.md` is updated to include the kernel analysis step in the "Phase Completion" protocol.
