...
- **Adversarial Audit (mandatory final step)** - After standard analysis, activate the [Adversarial Audit](reference/cross-cutting/adversarial-audit.md). Run the Undefined Path Hunt (§1), Plan Task Integrity check (§2), Test Coverage Legitimacy (§3), and Shenanigan Checklist (§5) before writing your verdict.
...
| **Adversarial Audit** | [Adversarial Audit Guide](reference/cross-cutting/adversarial-audit.md) | Undefined paths, missing else, hollow tests, false positive plan tasks, shenanigan checklist |
