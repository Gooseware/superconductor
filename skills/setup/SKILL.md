...
1.  **Analyze and Recommend:**
    ...
    -   Detect applicable skills based on `detectSignals` matched against project files and `superconductor/tech-stack.md`.
...
1.  **Generate Index File:**
    -   Create `superconductor/index.md` with the following content:
        ...
        ```
    -   **Announce:** "Created `superconductor/index.md` to serve as the project context index."
