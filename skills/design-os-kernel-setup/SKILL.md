---
name: superconductor-kernel-setup
...
## Overview
This skill guides the setup and configuration of the `superconductor-kernel`, the core MCP server that drives the Design OS automation.
