...
1. **Streaming Analysis:** The Review panel (`caduceus-reviewer`) must stream its diagnostic output as it parses code, allowing early aborts if critical vulnerabilities (like SQLi) are detected immediately.
