...
- [ ] Task: Update `skills/implement/SKILL.md` to add `README.md` and `AGENTS.md` synchronization logic to Phase 4.0. [TIER-3:TCS=5] [AGENT:caduceus-coder]
    - [ ] Add condition to check for build process/operational changes. [TIER-1:TCS=3]
    - [ ] Add "Propose and Confirm" diff prompt for `README.md`. [TIER-1:TCS=4]
    - [ ] Add "Propose and Confirm" diff prompt for `superconductor/AGENTS.md`. [TIER-1:TCS=4]
- [ ] Task: Superconductor - User Manual Verification 'Implementation' (Protocol in workflow.md) [TIER-1:TCS=4]
