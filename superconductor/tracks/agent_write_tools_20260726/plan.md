...
- [ ] Task: Write regression tests for agent manifest correctness [TIER-3] [AGENT:working-processor]
...
- [ ] Task: Fix `superconductor-processor/agent.md` — add full explicit tool list [TIER-2] [AGENT:working-processor]
...
- [ ] Task: Fix `superconductor-dreamer/agent.md` — add write + run tools [TIER-2] [AGENT:working-processor]
...
- [ ] Task: Fix `superconductor-oracle/agent.md` — add read + run tools [TIER-2] [AGENT:working-processor]
...
- [ ] Task: Fix `remediation-processor/agent.md` — add missing `run_command` [TIER-2] [AGENT:working-processor]
    - [ ] Add: `run_command` to the existing explicit list (already has write tools)
    - [ ] Retain all existing tools
- [ ] Task: Verify reviewer agents (security, correctness, adversarial, regression) are correctly read-only — no changes required, just confirm [TIER-2] [AGENT:working-processor]
...
- [ ] Task: Run regression tests — assert all manifest tests now pass (Green phase) [TIER-3] [AGENT:working-processor]
...
- [ ] Task: Integrate track 'agent_write_tools_20260726' into main branch. [TIER-2] [AGENT:working-processor]
